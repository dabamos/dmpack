% DMDWD(1) Version 2.0.0 | User Commands
...
**dmdwd** \--**node** *id* \--**sensor** *id* \--**target** *id* \--**station**
*id* \[\--**catalog** *path*\] \[\--**receiver** *name*\] \[\--**read** *type*\]
\[\--**interval** *seconds*\] \[\--**name** *name*\] \[\--**logger** *name*\]
\[\--**debug**\]
...
Wetterdienst (DWD) at
<[http://opendata.dwd.de/weather/weather_reports/poi/](http://opendata.dwd.de/weather/weather_reports/poi/)>
