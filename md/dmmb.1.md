% DMMB(1) Version 2.0.0 | User Commands
...
**dmmb** \--**config** *file* \[\--**name** *name*\] \[\--**node** *id*\]
\[\--**sensor** *id*\] \[\--**logger** *name*\] \[\--**format** *name*\]
\[\--**output** *file*\] \[\--**mqueue**\] \[\--**debug**\] \[\--**verbose**\]
...
:   Optional Modbus function code in hexadecimal format. Set to `0x01` to read
    coil status and to `0x05` to write coil status.
