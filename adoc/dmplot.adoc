...
*--terminal*, *-m* [ansi|ascii|gif|png|pngcairo|sixelgd|sixeltek|svg|x11]::
  Output terminal, either ANSI, ASCII, GIF, PNG, PNG (libcairo), Sixel (libgd),
  Sixel (bitmap), SVG, or X11. The terminal must be supported by _gnuplot(1)_.
