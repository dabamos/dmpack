...
[--*state* _n_]  [--*x* _x_] [--*y* _y_] [--*z* _z_] [--*longitude* _lng_]
[--*latitude* _lat_] [--*altitude* _alt_] [--*verbose*]
...
*--altitude*, *-A* _alt_::
  Node, sensor, or target altitude in metres.
...
*--latitude*, *-L* _lat_::
  Node, sensor, or target latitude in degrees (decimal).

*--longitude*, *-G* _lng_::
  Node, sensor, or target longitude in degrees (decimal).
