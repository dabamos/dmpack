...
| 0 | `RESPONSE_TYPE_REAL64` | Signed 8-byte real response value.
| 1 | `RESPONSE_TYPE_REAL32` | Signed 4-byte real response value.
| 2 | `RESPONSE_TYPE_INT64`  | Signed 8-byte integer response value.
| 3 | `RESPONSE_TYPE_INT32`  | Signed 4-byte integer response value.
| 4 | `RESPONSE_TYPE_BYTE`   | Byte response value.
|===
