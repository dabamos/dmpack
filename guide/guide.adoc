...
and the current month which will be passed to *dmreport*:
...
createReport () {
  ...
  ${dmreport} --name ${name} --config "${config}" --output "${path}" --from "${from}" --to "${to}"
}
...
Executing the shell script creates two reports, `2023-08_report.html` for time
series of the previous month, and `2023-09_report.html` for those of the current
month:
