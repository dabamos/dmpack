...
....
$ cd /tmp/
$ curl -O -L https://github.com/dabamos/dmpack/archive/refs/tags/1.0.0.tar.gz
$ tar xfvz 1.0.0.tar.gz
$ cd dmpack-1.0.0/
$ make linux
....
...
Download the source code of DMPACK 1.0.0:
...
....
$ doas pkg install archivers/zstd comms/libmodbus databases/sqlite3 \
...
.LLVM Compilers
====
If you prefer link:https://www.freshports.org/devel/llvm21/[LLVM 21] over GCC,
