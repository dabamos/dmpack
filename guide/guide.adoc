...
The *dmmb* program opens a Modbus RTU connection to slave device 1, then reads
temperature and humidity every 60 seconds. The observations are printed to
_stdout_ in JSONL format:
