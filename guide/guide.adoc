...
fastcgi.server = (
  "/api/v1" => ((
    "socket" => "/var/dmpack/lighttpd/sockets/dmapi.sock",
    "bin-path" => "/var/www/cgi-bin/dmapi",
    "max-procs" => 2,
    "check-local" => "disable",
    "bin-environment" => (
...
Set the environment variables to the location of the databases. The databases
must exist.
