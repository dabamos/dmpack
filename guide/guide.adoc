...
Executing the shell script creates two reports, `YYYY-MM_report.html` for time
series of the previous month, and `YYYY-MM_report.html` for those of the current
month, for example:
