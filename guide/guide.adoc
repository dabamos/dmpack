...
| `--elev _elev_`     | `-E`  | –       | Node, sensor, or target elevation (optional).
| `--help`            | `-h`  | –       | Print available command-line arguments and quit.
...
| `elev`    | double  | 8    | Sensor elevation (optional).
|===
...
| `elev`    | double  | 8    | Target elevation (optional).
|===
