...
client address, client library version, time stamp, system uptime, and last
...
| `time_sent` | string  | 30   | Date and time heartbeat was sent (ISO 8601).
| `time_recv` | string  | 30   | Date and time heartbeat was received (ISO 8601).
...
OBSERV%TIMESTAMP="1970-01-01T00:00:00.0000+00:00",
...
OBSERV%REQUESTS(1)%TIMESTAMP="1970-01-01T00:00:00.0000+00:00",
