...
observations from monitoring sensors, but not in active development anymore. The
project also provides a graphical user interface and a RESTful web API to
automate administration procedures. Developed by Istituto Scienze della Terra,
University of Applied Sciences and Arts of Southern Switzerland. (GPLv2)
...
store, serve/display, and monitor data from remote sensors. Apparently, the
development of the software is not continued. (MIT)
