...
In this case, path `/opt/bin` must be in environment variable `PATH`.
...
been compiled with GNU Fortran and are therefore incompatible.
====
...
To install to directory `/opt` instead, run:
