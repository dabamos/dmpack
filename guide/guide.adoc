...
output. The paper format of PDF/PS reports is DIN A4, with a maximum plot width
of 17{nbsp}cm. Any style sheet file with classless CSS can be included to alter
the presentation of the HTML report. A basic style sheet `dmreport.css` and its
