...
#define _BUILD_DATE_ "??? ?? ????"
    ...
    integer, parameter, public :: DM_VERSION_MAJOR = 1 !! DMPACK major version, from 0 to 9.
    integer, parameter, public :: DM_VERSION_MINOR = 0 !! DMPACK minor version, from 0 to 9.
    integer, parameter, public :: DM_VERSION_PATCH = 1 !! DMPACK patch level, from 0 to 9.
