...
module dm_tty
    ...
    !! == RTS - Request To Send
    !!
    !! The RTS signal is set to the space voltage by your workstation to
    !! indicate that more data is ready to be sent. Like CTS, RTS helps to
    !! regulate the flow of data between your workstation and the computer or
    !! device on the other end of the serial cable. Most workstations leave
    !! this signal set to the space voltage all the time.
    !!
    !! == DTR - Data Terminal Ready
    !!
    !! The DTR signal is generated by your workstation and tells the computer
    !! or device on the other end that you are ready (a space voltage) or
    !! not-ready (a mark voltage). DTR is usually enabled automatically
    !! whenever you open the serial interface on the workstation.
    !!
    !! For, further information to POSIX serial communications, see
    !! [Serial Programming Guide for POSIX Operating Systems](https://wiki.control.fel.cvut.cz/pos/cv5/doc/serial.html).
