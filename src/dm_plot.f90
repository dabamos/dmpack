...
module dm_plot
    ...
    type, public :: plot_type
        ...
        character(len=8)        :: foreground = ' '              !! Foreground colour (optional).
        ...
        type(pipe_type)         :: stdin                         !! Gnuplot's standard input.
        type(pipe_type)         :: stdout                        !! Gnuplot's standard output.
        type(pipe_type)         :: stderr                        !! Gnuplot's standard error.
    end type plot_type
