...
module dm_error
    ...
    integer, parameter, public :: E_CRYPTO            =  38 !! Cryptography error.
    ...
    ! IPC errors.
    integer, parameter, public :: E_IPC_ABORTED       = 180 !! IPC connection attempt aborted.
    integer, parameter, public :: E_IPC_ACCESS        = 181 !! IPC permission denied.
    integer, parameter, public :: E_IPC_AGAIN         = 182 !! IPC operation would block.
    ...
    integer, parameter, public :: E_IPC_INTERRUPTED   = 187 !! IPC operation interrupted.
    integer, parameter, public :: E_IPC_IN_USE        = 188 !! IPC address already in use.
    integer, parameter, public :: E_IPC_NOT_AVAILABLE = 189 !! IPC address is not available.
    integer, parameter, public :: E_IPC_NOT_SUPPORTED = 190 !! IPC protocol or option not supported.
    integer, parameter, public :: E_IPC_PROTOCOL      = 191 !! IPC protocol error.
    integer, parameter, public :: E_IPC_REFUSED       = 192 !! IPC connection refused.
    integer, parameter, public :: E_IPC_RESET         = 193 !! IPC connection reset by peer.
    integer, parameter, public :: E_IPC_SIZE          = 194 !! IPC message size is too large.
    integer, parameter, public :: E_IPC_STATE         = 195 !! IPC protocol state incorrect.
    integer, parameter, public :: E_IPC_TIMEOUT       = 196 !! IPC timeout occured.
    integer, parameter, public :: E_IPC_UNREACHABLE   = 197 !! IPC peer is unreachable.

    integer, parameter, public :: E_LAST              = 197 !! Never use this.
...
contains
    ...
    pure function dm_error_message(error) result(message)
        ...
        select case (error)
            ...
            case (E_CRYPTO);            message = 'cryptography error'
            ! Options.
            ...
            case (E_IPC_AGAIN);         message = 'IPC operation would block'
            ...
            case (E_IPC_INTERRUPTED);   message = 'IPC operation interrupted'
