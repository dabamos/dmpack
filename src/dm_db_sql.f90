...
module dm_db_sql
    ...
    integer, parameter, public :: DB_SQL_TABLE_NODES        =  1 !! Nodes table.
    integer, parameter, public :: DB_SQL_TABLE_SENSORS      =  2 !! Sensors table.
    integer, parameter, public :: DB_SQL_TABLE_TARGETS      =  3 !! Targets table.
    integer, parameter, public :: DB_SQL_TABLE_OBSERVS      =  4 !! Observations table.
    integer, parameter, public :: DB_SQL_TABLE_RESPONSES    =  5 !! Responses table.
    integer, parameter, public :: DB_SQL_TABLE_LOGS         =  6 !! Logs table.
    integer, parameter, public :: DB_SQL_TABLE_BEATS        =  7 !! Heartbeats table.
    integer, parameter, public :: DB_SQL_TABLE_TRANSFERS    =  8 !! Transfers table.
    integer, parameter, public :: DB_SQL_TABLE_IMAGES       =  9 !! Images table.
    integer, parameter, public :: DB_SQL_TABLE_SYNC_NODES   = 10 !! Sync nodes table.
    integer, parameter, public :: DB_SQL_TABLE_SYNC_SENSORS = 11 !! Sync sensors table.
    integer, parameter, public :: DB_SQL_TABLE_SYNC_TARGETS = 12 !! Sync targets table.
    integer, parameter, public :: DB_SQL_TABLE_SYNC_OBSERVS = 13 !! Sync observations table.
    integer, parameter, public :: DB_SQL_TABLE_SYNC_LOGS    = 14 !! Sync logs table.
    integer, parameter, public :: DB_SQL_TABLE_SYNC_IMAGES  = 15 !! Sync images table.
    integer, parameter, public :: DB_SQL_TABLE_LAST         = 15 !! Never use this.

    integer, parameter, public :: DB_SQL_TABLE_NAME_LEN = 12 !! Max. length of table names.

    character(*), parameter, public :: DB_SQL_TABLE_NAMES(DB_SQL_TABLE_LAST) = [ &
        character(DB_SQL_TABLE_NAME_LEN) :: &
        'nodes',        &
        'sensors',      &
        'targets',      &
        'observs',      &
    ...
    ! **************************************************************************
    ! Drop table.
    character(*), parameter, public :: DB_SQL_DROP_TABLE = "DROP TABLE IF EXISTS ?"

    ! Select all tables.
    character(*), parameter, public :: DB_SQL_SELECT_TABLES = &
        "SELECT "                                                                                  // &
    ...
    character(*), parameter, public :: DB_SQL_SELECT_TABLE = &
    ...
    ! **************************************************************************
    ! Beats schema.
    character(*), parameter, public :: DB_SQL_CREATE_BEATS = &
    ...
    ! Logs schema
    character(*), parameter, public :: DB_SQL_CREATE_LOGS = &
    ...
    ! Sensor nodes schema.
    character(*), parameter, public :: DB_SQL_CREATE_NODES = &
    ...
    ! Sensors schema.
    character(*), parameter, public :: DB_SQL_CREATE_SENSORS = &
    ...
    ! Targets schema.
    character(*), parameter, public :: DB_SQL_CREATE_TARGETS = &
    ...
    ! Observations schema.
    character(*), parameter, public :: DB_SQL_CREATE_OBSERVS = &
    ...
    ! Responses schema.
    character(*), parameter, public :: DB_SQL_CREATE_RESPONSES = &
    ...
    character(*), parameter, public :: DB_SQL_CREATE_SYNC_IMAGES = &
    ...
    character(*), parameter, public :: DB_SQL_CREATE_SYNC_LOGS = &
    ...
    character(*), parameter, public :: DB_SQL_CREATE_SYNC_NODES = &
    ...
    character(*), parameter, public :: DB_SQL_CREATE_SYNC_OBSERVS = &
    ...
    character(*), parameter, public :: DB_SQL_CREATE_SYNC_SENSORS = &
    ...
    ! Synchronised targets schema.
    character(*), parameter, public :: DB_SQL_CREATE_SYNC_TARGETS = &
    ...
    ! **************************************************************************
    character(*), parameter, public :: DB_SQL_CREATE_BEAT_INDICES(1) = [ character(64) :: &
        "CREATE INDEX IF NOT EXISTS idx_node_id ON beats(node_id)" &
    ]

    character(*), parameter, public :: DB_SQL_CREATE_LOG_INDICES(8) = [ character(64) :: &
    ...
    character(*), parameter, public :: DB_SQL_CREATE_OBSERV_INDICES(8) = [ character(128) :: &
    ...
    character(*), parameter, public :: DB_SQL_DELETE_OBSERV_TRIGGER = &
    ...
    character(*), parameter, public :: DB_SQL_DELETE_BEAT = &
        "DELETE FROM beats WHERE node_id = ?"

    ! Query to delete log.
    ! Arguments: logs.id
    character(*), parameter, public :: DB_SQL_DELETE_LOG = &
        "DELETE FROM logs WHERE id = ?"

    ! Query to delete node.
    ! Arguments: nodes.id
    character(*), parameter, public :: DB_SQL_DELETE_NODE = &
        "DELETE FROM nodes WHERE id = ?"

    ! Query to delete sensor.
    ! Arguments: sensors.id
    character(*), parameter, public :: DB_SQL_DELETE_SENSOR = &
        "DELETE FROM sensors WHERE id = ?"

    ! Query to delete target.
    ! Arguments: targets.id
    character(*), parameter, public :: DB_SQL_DELETE_TARGET = &
        "DELETE FROM targets WHERE id = ?"

    ! Query to delete observation.
    ! Arguments: targets.id
    character(*), parameter, public :: DB_SQL_DELETE_OBSERV = &
        "DELETE FROM observs WHERE id = ?"

    ! Query to delete all responses of an observation.
    ! Arguments: observ.id
    character(*), parameter, public :: DB_SQL_DELETE_RESPONSES = &
        "DELETE FROM responses WHERE observ_id = (SELECT row_id FROM observs WHERE id = ?)"
    ...
    character(*), parameter, public :: DB_SQL_INSERT_BEAT = &
        "INSERT INTO "                     // &
    ...
    character(*), parameter, public :: DB_SQL_INSERT_LOG = &
        "INSERT OR FAIL INTO "                                                                          // &
    ...
    character(*), parameter, public :: DB_SQL_INSERT_NODE = &
        "INSERT OR FAIL INTO "                                            // &
    ...
    character(*), parameter, public :: DB_SQL_INSERT_SENSOR = &
        "INSERT OR FAIL INTO "                                                                 // &
        "sensors(id, node_id, name, sn, meta, type, x, y, z, longitude, latitude, elevation) " // &
    ...
    character(*), parameter, public :: DB_SQL_INSERT_TARGET = &
        "INSERT OR FAIL INTO "                                                     // &
    ...
    !            observs.mode, observs.retries, observs.state, observs.timeout,
    !            observs.nresponses
    character(*), parameter, public :: DB_SQL_INSERT_OBSERV = &
        "INSERT OR FAIL INTO "                                                           // &
    ...
    character(*), parameter, public :: DB_SQL_INSERT_RESPONSE = &
        "INSERT OR FAIL INTO "                                        // &
        "responses(observ_id, idx, name, unit, type, error, value) "  // &
        "VALUES ("                                                    // &
        "(SELECT observs.row_id FROM observs WHERE observs.id = ?), " // &
        "?, ?, ?, ?, ?, ?)"
    ...
    character(*), parameter, public :: DB_SQL_UPDATE_NODE = &
    ...
    character(*), parameter, public :: DB_SQL_UPDATE_SENSOR = &
        "UPDATE OR FAIL sensors SET node_id = (SELECT row_id FROM nodes WHERE id = ?), " // &
        "name = ?, sn = ?, meta = ?, type = ?, x = ?, y = ?, z = ?, longitude = ?, latitude = ?, elevation = ? WHERE id = ?"
    ...
    !            targets.id
    character(*), parameter, public :: DB_SQL_UPDATE_TARGET = &
    ...
    character(*), parameter, public :: DB_SQL_SELECT_NLOGS = "SELECT COUNT(row_id) FROM logs"

    ! Query to select the number of observations.
    character(*), parameter, public :: DB_SQL_SELECT_NOBSERVS = &
        "SELECT COUNT(observs.row_id) FROM observs "                // &
        "INNER JOIN nodes ON nodes.row_id = observs.node_id "       // &
        "INNER JOIN sensors ON sensors.row_id = observs.sensor_id " // &
        "INNER JOIN targets ON targets.row_id = observs.target_id"
    ...
    character(*), parameter, public :: DB_SQL_SELECT_NOBSERV_VIEWS = &
        "SELECT COUNT(observs.row_id) FROM observs "                // &
        "INNER JOIN nodes ON nodes.row_id = observs.node_id "       // &
        "INNER JOIN sensors ON sensors.row_id = observs.sensor_id " // &
        "INNER JOIN targets ON targets.row_id = observs.target_id " // &
    ...
    character(*), parameter, public :: DB_SQL_SELECT_NSENSORS = &
    ...
    character(*), parameter, public :: DB_SQL_SELECT_BEATS = &
        "SELECT "     // &
        "node_id, "   // &
        "address, "   // &
        "client, "    // &
    ...
    character(*), parameter, public :: DB_SQL_SELECT_DATA_POINTS = &
        "SELECT "                                                     // &
        "observs.timestamp, "                                         // &
        "responses.value "                                            // &
        "FROM observs "                                               // &
    ...
    character(*), parameter, public :: DB_SQL_SELECT_LOGS = &
        "SELECT "     // &
        "id, "        // &
        "level, "     // &
        "error, "     // &
    ...
    character(*), parameter, public :: DB_SQL_SELECT_NODES = &
        "SELECT "           // &
        "nodes.id, "        // &
        "nodes.name, "      // &
        "nodes.meta, "      // &
    ...
    character(*), parameter, public :: DB_SQL_SELECT_OBSERV_IDS = &
    ...
    character(*), parameter, public :: DB_SQL_SELECT_OBSERVS = &
        "SELECT "                                                   // &
        "observs.id, "                                              // &
        "observs.group_id, "                                        // &
        "nodes.id, "                                                // &
    ...
    character(*), parameter, public :: DB_SQL_SELECT_OBSERV_VIEWS = &
        "SELECT "                                                     // &
        "observs.id, "                                                // &
        "observs.group_id, "                                          // &
        "nodes.id, "                                                  // &
    ...
    character(*), parameter, public :: DB_SQL_SELECT_RESPONSE = &
        "SELECT "                                                     // &
        "responses.name, "                                            // &
        "responses.unit, "                                            // &
        "responses.type, "                                            // &
        ...
        "responses.value "                                            // &
        "FROM responses "                                             // &
        "INNER JOIN observs ON observs.row_id = responses.observ_id " // &
        "WHERE observs.id = ? AND responses.idx = ?"

    ! Query to select the responses of a request.
    ! Arguments: observs.id
    character(*), parameter, public :: DB_SQL_SELECT_RESPONSES = &
        "SELECT "                                                     // &
        "responses.name, "                                            // &
        "responses.unit, "                                            // &
        "responses.type, "                                            // &
    ...
    character(*), parameter, public :: DB_SQL_SELECT_SENSORS = &
        "SELECT "             // &
        "sensors.id, "        // &
        "nodes.id, "          // &
        "sensors.name, "      // &
    ...
    character(*), parameter, public :: DB_SQL_SELECT_TARGETS = &
        "SELECT "             // &
        "targets.id, "        // &
        "targets.name, "      // &
        "targets.meta, "      // &
    ...
    ! **************************************************************************
    ! Transfers schema.
    character(*), parameter, public :: DB_SQL_CREATE_TRANSFERS = &
    ...
    character(*), parameter, public :: DB_SQL_CREATE_TRANSFER_INDICES(2) = [ character(64) :: &
    ...
    character(*), parameter, public :: DB_SQL_INSERT_TRANSFER = &
        "INSERT OR FAIL INTO "                                                           // &
        "transfers(id, node_id, type_id, timestamp, address, type, state, error, size) " // &
        "VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)"

    ! Query to select number of transfers.
    character(*), parameter, public :: DB_SQL_SELECT_NTRANSFERS = "SELECT COUNT(row_id) FROM transfers"

    ! Query to select transfers.
    character(*), parameter, public :: DB_SQL_SELECT_TRANSFERS = &
        "SELECT "               // &
        "transfers.id, "        // &
        "transfers.node_id, "   // &
        "transfers.type_id, "   // &
    ...
    character(*), parameter, public :: DB_SQL_UPDATE_TRANSFER = "UPDATE OR FAIL transfers"

    ! **************************************************************************
    ! IMAGE QUERIES.
    ! **************************************************************************
    ! Images schema.
    character(*), parameter, public :: DB_SQL_CREATE_IMAGES = &
    ...
    character(*), parameter, public :: DB_SQL_CREATE_IMAGE_INDICES(4) = [ character(64) :: &
    ...
    ! Arguments: images.id
    character(*), parameter, public :: DB_SQL_DELETE_IMAGE = &
        "DELETE FROM images WHERE id = ?"

    ! Query to check if image exists.
    ! Arguments: images.id
    character(*), parameter, public :: DB_SQL_HAS_IMAGE = &
    ...
    character(*), parameter, public :: DB_SQL_INSERT_IMAGE = &
        "INSERT OR FAIL INTO "                                                             // &
        "images(id, node_id, sensor_id, target_id, timestamp, mime, width, height, size) " // &
        "VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)"

    ! Query to select number of images.
    character(*), parameter, public :: DB_SQL_SELECT_NIMAGES = "SELECT COUNT(row_id) FROM images"

    ! Query to select images.
    character(*), parameter, public :: DB_SQL_SELECT_IMAGES = &
        "SELECT "            // &
        "images.id, "        // &
        "images.node_id, "   // &
        "images.sensor_id, " // &
    ...
    character(*), parameter, public :: DB_SQL_INSERT_SYNC_IMAGE = &
    ...
    character(*), parameter, public :: DB_SQL_INSERT_SYNC_LOG = &
    ...
    character(*), parameter, public :: DB_SQL_INSERT_SYNC_NODE = &
    ...
    character(*), parameter, public :: DB_SQL_INSERT_SYNC_OBSERV = &
    ...
    character(*), parameter, public :: DB_SQL_INSERT_SYNC_SENSOR = &
    ...
    character(*), parameter, public :: DB_SQL_INSERT_SYNC_TARGET = &
    ...
    character(*), parameter, public :: DB_SQL_SELECT_NSYNC_IMAGES = &
    ...
    character(*), parameter, public :: DB_SQL_SELECT_NSYNC_LOGS = &
    ...
    character(*), parameter, public :: DB_SQL_SELECT_NSYNC_NODES = &
    ...
    character(*), parameter, public :: DB_SQL_SELECT_NSYNC_OBSERVS = &
        "SELECT COUNT(observs.row_id) FROM observs "                         // &
    ...
    character(*), parameter, public :: DB_SQL_SELECT_NSYNC_SENSORS = &
        "SELECT COUNT(sensors.row_id) FROM sensors "                         // &
    ...
    character(*), parameter, public :: DB_SQL_SELECT_NSYNC_TARGETS = &
    ...
    character(*), parameter, public :: DB_SQL_SELECT_SYNC_IMAGES = &
        "SELECT "                                                                   // &
        "images.id, "                                                               // &
    ...
    character(*), parameter, public :: DB_SQL_SELECT_SYNC_LOGS = &
        "SELECT "                                                             // &
        "logs.id, "                                                           // &
        "sync_logs.timestamp, "                                               // &
        "sync_logs.code, "                                                    // &
    ...
    character(*), parameter, public :: DB_SQL_SELECT_SYNC_NODES = &
        "SELECT "                                                    // &
        "nodes.id, "                                                 // &
    ...
    character(*), parameter, public :: DB_SQL_SELECT_SYNC_OBSERVS = &
        "SELECT "                                                                      // &
        "observs.id, "                                                                 // &
    ...
    character(*), parameter, public :: DB_SQL_SELECT_SYNC_SENSORS = &
        "SELECT "                                                            // &
        "sensors.id, "                                                       // &
    ...
    character(*), parameter, public :: DB_SQL_SELECT_SYNC_TARGETS = &
        "SELECT "                                                            // &
        "targets.id, "                                                       // &
